...
public enum Option {
    ...
    /**
     * This mode can be used query at special filters or slices.
     * This mode treat the result of filter and slices as array, and it might be useful to some situation.
     * For example:
     *
     * Given:
     * <pre>
